...
public class C
{
    ...
    public final static String[] bookFields = { field.id, field.title, field.author, field.pubDate, field.publisher, field.isbn, field.summary, field.imageSmall, field.imageLarge};
}
